...
{%- if cell.metadata.slide_type in ['slide'] -%}
    <section>
    <section{% if cell.metadata.slide_bg_transition %} data-background-transition="{{ cell.metadata.slide_bg_transition }}"{% endif %}
            {% if cell.metadata.slide_bg %} data-background="{{ cell.metadata.slide_bg }}"{% endif %}
            {% if cell.metadata.slide_bg_size %} data-background-transition="{{ cell.metadata.slide_bg_size }}"{% endif %}
            {% if cell.metadata.slide_state %} data-state="{{ cell.metadata.slide_state }}"{% endif %}>
    {%- if cell.metadata.slide_logo -%}
    <div class="cell border-box-sizing text_cell rendered">
    <div class="prompt input_prompt">
    </div>
    <div class="inner_cell">
    <div class="text_cell_render border-box-sizing rendered_html">
        <img src="{{ cell.metadata.slide_logo }}" />
    </div>
    </div>
    </div>
    {%- endif -%}
    {{ super() }}
    {%- if cell.metadata.slide_valign and cell.metadata.slide_valign in ['top'] -%}
...
{%- elif cell.metadata.slide_type in ['subslide'] -%}
    <section{% if cell.metadata.slide_bg_transition %} data-background-transition="{{ cell.metadata.slide_bg_transition }}"{% endif %}
            {% if cell.metadata.slide_bg %} data-background="{{ cell.metadata.slide_bg }}"{% endif %}
            {% if cell.metadata.slide_bg_size %} data-background-transition="{{ cell.metadata.slide_bg_size }}"{% endif %}
            {% if cell.metadata.slide_bg_repeat %} data-background-repeat="{{ cell.metadata.slide_bg_repeat }}"{% endif %}
            {% if cell.metadata.slide_state %} data-state="{{ cell.metadata.slide_state }}"{% endif %}>
    {%- if cell.metadata.slide_logo -%}
    <div class="cell border-box-sizing text_cell rendered">
    <div class="prompt input_prompt">
    ...
    {%- endif -%}
    {%- if cell.metadata.slide_valign and cell.metadata.slide_valign in ['bottom'] -%}
<br/><br/><br/><br/><br/><br/><br/><br/>
<br/><br/><br/><br/><br/><br/><br/><br/>
<br/><br/><br/><br/>
    {%- endif -%}
...
<script src="libs/require.js/2.1.10/require.min.js"></script>
