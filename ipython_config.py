...
#------------------------------------------------------------------------------
# On save, nbconvert the notebook into different formats.
# Src: http://bit.ly/post-save-hook-snippet
#------------------------------------------------------------------------------
import os
from subprocess import check_call

def post_save(model, os_path, contents_manager):
    """ post-save hook for converting notebooks to markdown files.
    """
...
# c.TerminalInteractiveShell.banner1 = 'Python 2.7.10 (default, May 25 2015, 13:05:06) \nType "copyright", "credits" or "license" for more information.\n\nIPython 3.2.1 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
