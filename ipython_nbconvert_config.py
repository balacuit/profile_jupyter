...
# Name of the template file to use
c.MarkdownExporter.template_file = u'./profile_default/templates/markdown.tpl'
...
# Name of the template file to use
c.RSTExporter.template_file = u'./profile_default/templates/rst.tpl'
...
# Name of the template file to use
c.SlidesExporter.template_file = u'./profile_default/templates/html/slides_reveal.tpl'
...
c.RevealHelpPreprocessor.url_prefix = 'libs/reveal.js'
